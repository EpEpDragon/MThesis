...
\subsection{Choosing The Supporting And Swinging Legs} \label{sec:supp_swing_calc}
    ...
    \subsubsection{For Supporting Legs} \label{sec:support}
        ...
        \begin{figure}[h]
            \centering
            % \hspace{1.1cm}
            \includegraphics[clip, trim=3.1cm 0.25cm 3.35cm 0.25cm]{Diagrams-ChooseNominalSupp.drawio.pdf}
    ...
    \subsubsection{For Swinging Legs} \label{sec:swing}
        ...
        \begin{figure}[h]
            \centering
            % \hspace{1.1cm}
            \includegraphics[clip, trim=3.25cm 0.25cm 5.1cm 0.3cm]{Diagrams-ChooseNominalSwing.drawio.pdf}
            \caption{Supporting target choosing diagram} 
            \label{fig:supp_targ}
        \end{figure}
    ...
    \subsection{Improved System}
        ...
        \begin{figure}[h]
            \centering
            \hspace{-1.38cm}
            \includegraphics[clip, trim=0 3.25cm 0 0.25cm]{foot_path.pdf}
...
\section{Kinematics}
    ...
    \subsection{Coordinate Frames}
        ...
        \begin{figure}[h]
            \centering
            % \hspace{-1.38cm}
            \includegraphics[width=.7\textwidth]{hexCoords.png}
            \caption{Body and leg coordinate frames.}
            \label{fig:coords_top}
        \end{figure}
        The leg coordinate systems are simply rotated and shifted from the body coordinate system. This transformation,\transframenew{\bm{x}^\fbody, i}{\fbody}{\fleg} is defined by equation \ref{eq:body_to_leg},
