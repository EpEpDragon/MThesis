\chapter{Mapping} \label{chap:mapping}
    ...
    \section{Updating the Heightmap}
        ...
        \begin{align} \label{eq:map_index}
            ...
            \end{split}
        \end{align}
        where \([x\inrefframe{\fworld}, y\inrefframe{\fworld}]\) are the horizontal coordinates in the world frame, \(\Delta\) is the scaling of the heightmap, and \(N\) is the side length of the 2D array that stores the heightmap.
